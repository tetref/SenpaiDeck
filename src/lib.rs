...
#[derive(Debug)]
pub struct SenpaiDeckProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SenpaiDeckProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SenpaiDeck processing");
    
    let mut processor = SenpaiDeckProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SenpaiDeckProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SenpaiDeckProcessor::new(false);
